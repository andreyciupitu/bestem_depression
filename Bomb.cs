...
public class Bomb : MonoBehaviour
{
	...
	void Awake ()
	{
		...
		//TODO pickupSpawner = GameObject.Find("pickupManager").GetComponent<PickupSpawner>();
    ...
    { 
		...
		foreach(Collider2D en in enemies)
		{
			...
			if(rb != null && rb.tag == "Player")
			{
                ...
                rb.gameObject.GetComponent<PlayerHealth>().TakeDamage(55 * 1/deltaPos.magnitude, gameObject.tag);
